...
class ConvertModel
{
    ...
    std::string image_file = "/home/lixj/Downloads/trt_test/data/test.jpg";
    std::string data_path =  "/home/lixj/Downloads/trt_test/data/";
    std::string engine_path =  "/home/lixj/Downloads/trt_test/data/mb2-ssd-lite.engine";
    std::string onnx_file = "/home/lixj/Downloads/trt_test/data/mb2-ssd-lite-tlr.onnx";
    std::string filepath = "/home/lixj/Downloads/trt_test/data/voc_labels_tl2.txt";
